        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <div class="panel panel-default">
                    ...
                    <legend>{{ text.simple('create') }}</legend>
...
/*{for:areas}*/
                            <fieldset>
                                <div class="form-group {% if form.messages('/*{areas>name}*/') %}has-error{% endif %}">
                                    ...
                                    <div class="col-sm-10">
                                       {#<textarea class="input-block-level summernote" name="/*{areas>name}*/"></textarea>#}
                                        <input type="input" name="/*{areas>name}*/" class="form-control" data-parsley-minlength="3" data-parsley-type="alphanum">{{ form.messages('/*{areas>name}*/') }}
                                    </div>
                                </div>
                            </fieldset>
/*{/for}*/ 
                            ...
                            <button type="submit" class="btn btn-primary"><i class="fa fa-check"></i>{{ text.simple('submit') }}</button>
                        </form>
                    </div>
                </div>
            </div>
