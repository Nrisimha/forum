        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <div class="panel panel-default">
                    <div class="panel-body">
                        <form action="{{ viewconf.baseurl }}{{lang}}/user/slogin" method="post" data-parsley-validate="" novalidate="" data-persist="garlic" data-destroy="false">
                            ...
                            <fieldset>
                                <div class="form-group {% if form.messages('email') %}has-error{% endif %}">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="input" name="email" class="form-control" data-parsley-minlength="6">{{ form.messages('email') }}{{ form.messages('email') }}
                                    </div>
                                </div>
                            </fieldset>
