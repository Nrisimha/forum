        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <div class="panel panel-default">
                    <div class="panel-body">
                        <form action="{{ viewconf.baseurl }}{{lang}}/user/signup" method="post" data-parsley-validate="" novalidate="" data-persist="garlic" data-destroy="false">
                            ...
                            <fieldset>
                                <div class="form-group {% if form.messages('name') %}has-error{% endif %}">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="input" name="nick" class="form-control" data-parsley-minlength="3" data-parsley-type="alphanum">{{ form.messages('name') }}
                                    </div>
                                </div>
                            </fieldset>
