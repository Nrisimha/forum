            ...
            <nav role="navigation" class="navbar topnavbar">
                ...
                <div class="navbar-collapse collapse">
                    ...
                    <ul class="nav navbar-nav">
                        <li><a href="#dashboard" data-toggle="dropdown">{{ text.simple('forum') }}</a>
                            <ul class="dropdown-menu animated fadeIn">
                                <li><a href="{{viewconf.baseurl}}en/forum">English</a></li>
                                <li><a href="{{viewconf.baseurl}}fr/forum">French</a></li>
                                <li><a href="{{viewconf.baseurl}}de/forum">German</a></li>
                                <li><a href="{{viewconf.baseurl}}pl/forum">Polish</a></li>
                                <li><a href="{{viewconf.baseurl}}pt/forum">Portuguese</a></li>
                                <li><a href="{{viewconf.baseurl}}ru/forum">Russian</a></li>
                                <li><a href="{{viewconf.baseurl}}es/forum">Spanish</a></li>
                                <li><a href="{{viewconf.baseurl}}tr/forum">Turkish</a></li>
                            </ul>
                        </li>
                    </ul>
                    <!-- START Right Navbar-->
