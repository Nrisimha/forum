...
$at["test_text_without_a_variable"] = "Test text without a variable";
$at["test_text_with_VAR_variable"] = "Test text with '%s' variable";
$at["NAME_SURNAME_your_age_is_AGE"] = "Welcome, %name% %surname% your age is %age%.";
